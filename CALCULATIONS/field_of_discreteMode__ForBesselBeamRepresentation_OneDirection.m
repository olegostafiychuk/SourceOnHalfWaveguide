...
function component = field_of_discreteMode__ForBesselBeamRepresentation_OneDirection(componentOfField, typeOfCylinder, r, q, p, a_p_field, q_0, k_0, k, a_0, EE1, GG1, HH1, MU1, EE2, MU2, EE, MU, m, z, AE_0, AH_0)
 ...
 %%%         [B_1_backward,B_2_backward,Cm2_backward, Dm2_backward] = coefficientsOfContinuousSpectrum(typeOfCylinder, k_0, k_0, a_0, EE1,0,0, MU1, EE, MU,  m, (-p), 0, 1);
          ...
          switch(componentOfField)
              case 'Ez'
                  ...
                  q1.*(a_p_field.* B_1_forward.*  EE1 * Jm).*(r<a_0);
              case 'Hz'
