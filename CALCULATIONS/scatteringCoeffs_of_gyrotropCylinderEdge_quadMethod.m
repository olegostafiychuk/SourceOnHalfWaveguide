function [b_p_field_1_back,b_p_field_2_back, b_n_back,a_p_Ebeam_forw,a_p_Hbeam_forw] =...
               scatteringCoeffs_of_gyrotropCylinderEdge_quadMethod(typeOfCylinder, dq_simp, q, p, q_n, p_n, q_0, p_0, k_0, k, a_0, EE1, GG1, HH1, MU1, EE2, MU2, EE, MU, m, z0, AE_0, AH_0)
...
%         end
            ...
            rightSide(iq + (ialpha-1)*Nmax + bNmax) = rightSide(iq + (ialpha-1)*Nmax + bNmax) +...
                           (2 - ialpha) * k_0/2/pi * K_beta0PL_alphEMin(iq) +...
