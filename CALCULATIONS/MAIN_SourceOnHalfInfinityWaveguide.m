...
NL1 = 50; % % требуетс€ как минимум 1120 точек на одну длину волны дл€ w=w0.025w_H
NL2 = 35;
...
P_ratio = (P_cs_forw_waveguide + P_mod_forw_waveguide)/(P_cs_back + P_cs_forw + P_mod_back) % проверка сохранени€ энергии при дифракции
...
% 
% %for home station
% save('C:\Users\ќлег\Dropbox\PAPERS\URSI GASS 2020\coefficients_0025wH_n1e13_L_lambda0.mat',...
%     'a_cs_alfa1_back_prop', 'a_cs_alfa2_back_prop', 'b_p_field_1_back_prop', 'b_p_field_2_back_prop',...
