...
%         end
            ...
            rightSide(iq + (ialpha-1)*Nmax + bNmax) = rightSide(iq + (ialpha-1)*Nmax + bNmax) +...
                                   - k_0/2/pi * (2 - ialpha) * q(iq).*...
                                     (M_core_beta1_alphaE(iq).* a_cs_alfa1_forw(iq) +...
                                      M_core_beta2_alphaE(iq).* a_cs_alfa2_forw(iq)) +...
                                   - k_0/2/pi * (ialpha - 1) * q(iq).*...
                                     (M_core_beta1_alphaH(iq).* a_cs_alfa1_forw(iq) +...
                                      M_core_beta2_alphaH(iq).* a_cs_alfa2_forw(iq));
