function K_beta_s_m_talpha_ts_tm =...
          K_core_speedy_gyro(typeOfCylinder, q, p, psi, m, H2m, dH2m, H1m, dH1m,...
                                tq, tp, tm,...
                 k_0, k, a_0, EE1, GG1, HH1, MU1, EE2, MU2, EE, MU, z0, B_1, B_2, Cm2, Dm2, AE_0, AH_0,...
                 Jtmtq,Jtmpl1tq, Jtm_1tq, Jtmpl2tq,...                              
                     Jtmq1, Jtm_1q1, Jtmpl1q1, Jtmpl2q1,...
                     JM0,JM1,JM2,JMM0,JMM1,JMM2,Jm0,Jm1,Jm2,...
...
switch(typeOfCylinder)
    ...
    case 'PerfectConductivity'
        ...
        K_beta_s_m_talpha_ts_tm = S_plus.* exp(-1i*(p+p_0)*k_0*z0);
