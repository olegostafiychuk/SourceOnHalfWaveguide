...
function aplus2 = a_sma_of_continuousWaves_alpha2(typeOfCylinder, q, p_0, p, k_0, a_0, EE1, GG1, HH1, MU1, EE, MU, c, m, z, I_f, I_z, d)

switch(typeOfCylinder)
    case 'Isotropic'
        psi  = psi2_q(k_0, k_0, a_0, EE1, MU1, EE, MU, m, p, q);
        [B_1, B_2, Cm2, Dm2]  = coefficientsOfContinuousSpectrum_forPsi2(typeOfCylinder, k_0, k_0, a_0, EE1, GG1, HH1, MU1, EE, MU, m, p, q, psi,  1);
        %%%%%% norm %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        N_p = Norm_of_continuousWaves(q, p, k_0, c, m, psi, Cm2, Dm2);        
        
        psi  = psi2_q(k_0, k_0, a_0, EE1, MU1, EE, MU, -m, -p, q);
%         [B_1, B_2, Cm2, Dm2]  = coefficientsOfContinuousSpectrum(typeOfCylinder, k_0, k_0, a_0, EE1, GG1, HH1, MU1, EE, MU, m, p, psi,  1);
        [B_1, B_2, Cm2, Dm2]  = coefficientsOfContinuousSpectrum_forPsi2(typeOfCylinder, k_0, k_0, a_0, EE1, -GG1, HH1, MU1, EE, MU, -m, -p, q, psi,  1);
    ...
    case 'Gyrotropic'
        psi   = psi2_q__gyrotropic(k_0, k_0, a_0, EE1,  GG1, HH1,  m, p, q);
        [B_1, B_2, Cm2, Dm2]  = coefficientsOfContinuousSpectrum_forPsi2(typeOfCylinder, k_0, k_0, a_0, EE1, GG1, HH1, MU1, EE, MU, m, p,  q, psi,  1);
        %%%%%% norm %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        N_p = Norm_of_continuousWaves(q, p, k_0, c, m, psi, Cm2, Dm2);
